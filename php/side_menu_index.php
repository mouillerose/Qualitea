    ...
    <ul id="side">
            ...
            $taille=count($_SESSION['categorie']);
                ...
                foreach ($_SESSION['categorie'] as $x){
                    $y=$x[5];
                    $z=$x[6];
                    echo "<li><a href=\"./php/produits.php?categorie=$y\" style=\"color:#427a51\">$z</href></a></li>";
                }
            
    ?>
            <li id="bouton_contact"><a href="./php/contact.php" style="color:#427a51">Contact</href></a></li>
    </ul>
    </nav>
</section>